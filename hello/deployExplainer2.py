...
class explainer:
    ...
    def __init__(self,training_data, feature_names,class_names, kernel_width,categorical_features, categorical_names):
    ...
    def explain(self, model, case, num_features=5):
        np.random.seed(1)
        i = 30
        user_case = case
